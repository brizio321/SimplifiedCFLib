...
def move(self):
    ...
    time.sleep(3)
    self.go_to(p0[0, 0], p0[1, 0], z=0.7)
    time.sleep(3)
    self.go_to(p0[0, 0], p0[1, 0], z=0.4)
    time.sleep(3)

    # Move along x axis
    self.go_to(p0[0, 0]+0.4, p0[1, 0], z=0.60)
    time.sleep(3)
    self.go_to(p0[0, 0]-0.4, p0[1, 0], z=0.60)
    time.sleep(3)
    ...
    # Move along y axis
    self.go_to(p0[0, 0], p0[1, 0]+0.4, z=0.60)
    time.sleep(3)
    self.go_to(p0[0, 0], p0[1, 0]-0.4, z=0.60)
    time.sleep(3)
    self.go_to(p0[0, 0], p0[1, 0], z=0.60)
...
if __name__ == '__main__':
    ...
    rot_ot2uwb, rssd = R.align_vectors(cf._pos[:, idx_t0:idx_tf].T, oc._tracked_pos[frame_id][:, idx_t0:idx_tf].T)

    # p_uwb = O_ot_in_uwb + rot_ot2uwb @ p_ot
    O_ot_in_uwb = cf._pos[:, idx_t0] - rot_ot2uwb.as_matrix()@oc._tracked_pos[frame_id][:, idx_t0]

    # Store the configuration
    filename = "./config/ot_uwb_config"
